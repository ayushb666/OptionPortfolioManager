...
namespace PortfolioManager.Classes
{
    ...
    class BarrierOption:Options
    {
        ...
        public BarrierOption(String issuer, string symbol, ISecurity underlying, DateTime expiryDate, double strikePrice, double historicalVolatility, String isin, Boolean isTradable, OptionType type, OptionKind optionKind, Double barrier, BarrierOptionType barrierOptionType)
        {
            this.issuer = issuer;
            this.symbol = symbol;
            this.underlying = underlying;
