...
namespace PortfolioManager.Classes
{
    class EuropeanOption : Options
    {
        ...
        public EuropeanOption(string symbol, ISecurity underlying, DateTime expiryDate, double strikePrice, double historicalVolatility, OptionType type, OptionKind optionKind)
        {
            this.symbol = symbol;
        ...
        public EuropeanOption(String issuer, Exchange[] tradedOnExchange, string symbol, ISecurity underlying, DateTime expiryDate, double strikePrice, double historicalVolatility, String isin, Boolean isTradable, OptionType type, OptionKind optionKind)
        {
            this.issuer = issuer;
