...
namespace PortfolioManager.Classes
{
    class AsianOption:Options
    {
        ...
        public AsianOption(String issuer, string symbol, ISecurity underlying, DateTime expiryDate, double strikePrice, double historicalVolatility, String isin, Boolean isTradable, OptionType type, OptionKind optionKind)
        {
            this.issuer = issuer;
            this.symbol = symbol;
            this.underlying = underlying;
