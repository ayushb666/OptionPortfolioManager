...
namespace PortfolioManager.Classes
{
    class AsianOption:Options
    {
        ...
        public AsianOption(string symbol, ISecurity underlying, DateTime expiryDate, double strikePrice, double historicalVolatility, OptionType type, OptionKind optionKind)
        {
            this.symbol = symbol;
        ...
        public AsianOption(String issuer, Exchange[] tradedOnExchange, string symbol, ISecurity underlying, DateTime expiryDate, double strikePrice, double historicalVolatility, String isin, Boolean isTradable, OptionType type, OptionKind optionKind)
        {
            this.issuer = issuer;
